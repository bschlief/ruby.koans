...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
	...
	# BMS: By reusing the same memory with the << operator, when we 
	# exceed the length of the allocated memory, we get another block 
	# off the heap.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
	# BMS: ruby 1.8.7 returns the character value instead of a char witht he letter.
	# I've added a 1.9.X do..end portion of the program.
  end
  ...
  in_ruby_version("1.9") do
	...
	# BMS: Ran with 1.9.1 also to test this. It passes now.
  end
