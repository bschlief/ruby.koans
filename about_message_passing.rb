...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # BMS: Other objects may want to use send (sockets, for example)
    # which would then collide with the object level definition of
    # send.  Therefore __send__ was added which will always allow
    # you to __send__ a message to the object.
  end
