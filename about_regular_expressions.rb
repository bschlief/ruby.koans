...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
	...
	# BMS: When you have something before and after the * to block the match
  end
  ...
  #
  # Why?
  # BMS: They match the first occurrence.
  ...
  # BMS: Character class is independent of order.  The alternation requires that the
  # characters be in a particular order
