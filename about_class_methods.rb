...
class AboutClassMethods < EdgeCase::Koan
  ...
  #BMS: It's not clear to me what the purpose of the class methods are
  #probably since I've only typically used instance methods.  Perhaps
  #its lke static methods in Java?      
  ...
  # BMS: I like the self.method better than class << self, because the
  # doubling up of the class keyword looks awkward to me personally. 
  # ------------------------------------------------------------------
