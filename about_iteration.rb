...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # allows you o build a result, item by item, passing the result
    # in at each item.  You can inject an initial value in the parens
    # before the block.
  end
  ...
  # BMS: My guess is that if the file didn't exist, then the
  # code to read file is protected automatically.
end
